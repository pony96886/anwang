...
class HomeSubPage extends StatefulWidget {
  HomeSubPage({required this.linkModel, this.isDiscover = false});
...
class _HomeSubPageState extends State<HomeSubPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List sortNavis =
        Provider.of<BaseStore>(context, listen: false).conf?.config?.sort_nav ??
            [];
    ...
    return NestedScrollView(
      ...
      body: GenCustomNav(
        ...
        isCenter: true,
        selectStyle: StyleTheme.font_blue52_13_medium,
        defaultStyle: StyleTheme.font_black_7716_13,
      ),
    );
  }
}
