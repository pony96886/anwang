...
class _ShortvMvPlayerState extends State<ShortvMvPlayer> with NVideoURLMinxin {
  ...
  void byVideoRes(int money) {
    ...
    reqBuyVideo(id: widget.info?['id'] ?? 0, money: money, context: context)
        .then((value) {
      //关闭加载动画
      Utils.closeGif();
      if (value?.status == 1) {
                      ...
                      !flickVideoManager.videoPlayerValue!.isInitialized ||
                          ...
                          ? FlickVideoProgressBar(
                              flickProgressBarSettings:
                                ...
                                bufferedColor:
                                    const Color(0xFF3488ff).withOpacity(0.38),
                                playedColor: const Color(0xFF3488ff),
                                handleColor: const Color(0xFF3488ff),
                              ),
                            )
                          : Container(),
                    ],
