...
import 'package:deepseek/acgn/game/game_rec_page.dart';
import 'package:deepseek/acgn/game/game_sub_page.dart';
...
class _GamePageState extends State<GamePage> {
  ...
  getData() {
    topNavs =
        Provider.of<BaseStore>(context, listen: false).conf?.game_top_nav ?? [];
