...
class GameSubChildPage extends StatefulWidget {
  GameSubChildPage(
  ...
  @override
  State<GameSubChildPage> createState() => _GameSubChildPageState();
}

class _GameSubChildPageState extends State<GameSubChildPage> {
  bool isHud = true;
  bool netError = false;
  bool noMore = false;
  int page = 1;
  ...
  Future<bool> getData() async {
    ...
    dynamic res = await reqGameThemeList(
        ...
        : netError
            ...
            : array.isEmpty
                ...
                : PullRefresh(
                    ...
                    child: Utils.gameListView(context, array),
                  );
  }
}
