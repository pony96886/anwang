import 'package:deepseek/acgn/novel/novel_rec_page.dart';
import 'package:deepseek/acgn/novel/novel_sub_page.dart';
...
class _NovelPageState extends State<NovelPage> {
  ...
  getData() {
    topNavs =
        Provider.of<BaseStore>(context, listen: false).conf?.novel_nav ?? [];
