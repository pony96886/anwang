import 'package:deepseek/acgn/novel/novel_subchild_page.dart';
...
class NovelSubPage extends StatefulWidget {
  NovelSubPage({required this.linkModel, this.isDiscover = false});

  final LinkModel linkModel;
  final bool isDiscover;

  @override
  State<NovelSubPage> createState() => _NovelSubPageState();
}

class _NovelSubPageState extends State<NovelSubPage> {
