...
class NovelSubChildPage extends StatefulWidget {
  NovelSubChildPage(
  ...
  @override
  State<NovelSubChildPage> createState() => _NovelSubChildPageState();
}

class _NovelSubChildPageState extends State<NovelSubChildPage> {
  bool isHud = true;
  bool netError = false;
  bool noMore = false;
  int page = 1;
  ...
  Future<bool> getData() async {
    ...
    dynamic res = await reqNovelThemeList(
