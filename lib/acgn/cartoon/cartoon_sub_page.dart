import 'package:deepseek/acgn/cartoon/cartoon_subchild_page.dart';
...
class CartoonSubPage extends StatefulWidget {
  CartoonSubPage({required this.linkModel, this.isDiscover = false});

  final LinkModel linkModel;
  final bool isDiscover;

  @override
  State<CartoonSubPage> createState() => _CartoonSubPageState();
}

class _CartoonSubPageState extends State<CartoonSubPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List sortNavis =
        Provider.of<BaseStore>(context, listen: false).conf?.cartoon_sort_nav ??
            [];
