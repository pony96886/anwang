...
class MineBuyPage extends BaseWidget {
  MineBuyPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> cState() {
    // TODO: implement cState
    return _MineBuyPageState();
  }
}

class _MineBuyPageState extends BaseWidgetState<MineBuyPage> {
  List<MediaType> navs = [
    MediaType.mv,
    MediaType.vlog,
    MediaType.post,
  ...
  void onCreate() {
    ...
    setAppTitle(
        titleW: Text(Utils.txt('wdgm'), style: StyleTheme.nav_title_font));
  }
